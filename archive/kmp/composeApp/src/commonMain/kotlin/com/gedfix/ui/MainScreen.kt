    ...
    Row(modifier = Modifier.fillMaxSize()) {
        ...
        Surface(
            ...
            when (appViewModel.selectedSection) {
                ...
                SidebarSection.GROUPS -> GroupsScreen(appViewModel)
                SidebarSection.CONTRADICTIONS -> ContradictionsScreen(appViewModel)
                SidebarSection.RESEARCH_LOG -> ResearchLogScreen(appViewModel)
                SidebarSection.MAPS -> MapsScreen(appViewModel)
                SidebarSection.DNA_TOOLS -> DNAToolsScreen(appViewModel)
